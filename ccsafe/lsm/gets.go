...
// M - get my content as map[key]value-string
//  {{ .M.key }}
// fetches key="key" from the map
// and returns its content as string, iff any
...
// Range - get my values as slice, sorted by name
//  {{ range .Range }}...{{end}}
...
// LSM - get my complete content as is
